...
class Disable extends \M2E\AmazonMcf\Controller\Adminhtml\AbstractBase
{
    use ActionTrait;
    ...
    {
        $this->productRepository->disableByMassActionFilter($this->massActionFilter);

        $this->getMessageManager()->addSuccessMessage(
            __('MCF synchronization has been disabled for the selected Products')
        );
