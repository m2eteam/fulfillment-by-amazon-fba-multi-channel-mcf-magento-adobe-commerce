...
class MassActionFilter extends \Magento\Ui\Component\MassAction\Filter
{
    /** @var \Magento\Framework\View\Element\UiComponent\DataProvider\DataProviderInterface */
    private $dataProvider;

    public function getCollection(AbstractDb $collection): AbstractDb
    {
    ...
    private function getFilterIds(): array
    {
        $idsArray = [];
    ...
    public function applySelectionOnTargetProvider(): void
    {
        $selected = $this->request->getParam(static::SELECTED_PARAM);
        $excluded = $this->request->getParam(static::EXCLUDED_PARAM);
        if ('false' === $excluded) {
    ...
    /**
     * @return \Magento\Framework\View\Element\UiComponent\DataProvider\DataProviderInterface
     */
