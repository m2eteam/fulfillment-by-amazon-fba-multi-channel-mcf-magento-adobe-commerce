...
class Manager
{
    ...
    private string $nick;
    private \M2E\AmazonMcf\Model\ResourceModel\Lock\Item\CollectionFactory $lockItemCollectionFactory;
    ...
    public function __construct(
        ...
        \M2E\AmazonMcf\Model\ResourceModel\Lock\Item\CollectionFactory $lockItemCollectionFactory,
        string $nick
    ) {
    ...
    public function remove(): bool
    {
        ...
        /** @var \M2E\AmazonMcf\Model\Lock\Item[] $childLockItems */
    ...
    public function activate(): void
    {
        $lockItem = $this->getLockItemObject();
        if ($lockItem === null) {
            throw new \M2E\AmazonMcf\Model\Exception(
    ...
    private function getLockItemObject(): ?\M2E\AmazonMcf\Model\Lock\Item
    {
        $lockItemCollection = $this->lockItemCollectionFactory->create();
        $lockItemCollection->addFieldToFilter('nick', $this->nick);

        /** @var \M2E\AmazonMcf\Model\Lock\Item $lockItem */
