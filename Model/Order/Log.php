...
use M2E\AmazonMcf\Model\ResourceModel\Order\Log as LogResource;
...
class Log extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        parent::_construct();
        $this->_init(\M2E\AmazonMcf\Model\ResourceModel\Order\Log::class);
    }
    ...
    public function init(
        ...
        $this->setData(LogResource::COLUMN_ORDER_ID, $orderId);
