define([
    ...
    'underscore',
    'AmazonMcf/Plugin/Magento/AttributeCreator',
    'AmazonMcf/Attribute'
    ...
    window.MagentoAttributeButton = Class.create({
        ...
        _template: "<fieldset class='fieldset admin__fieldset  AmazonMcf-fieldset'>" +
        ...
        init: function (element, callback) {
            ...
            var popup = jQuery(popupElement).modal({
                title: AmazonMcf.translator.translate(
                ...
                buttons: [{
                    ...
                    text: AmazonMcf.translator.translate('Insert'),
        ...
        _renderMagentoAttributes: function (containerElement) {
            ...
            var select = new Element('select',
                    _.extend({
                        ...
                        class: 'select admin__control-select AmazonMcf-custom-attribute-can-be-created',
            ...
            containerElement.innerHTML = _.template(this._template)({
                id: 'magento-attribute-select-' + this._id,
                title: AmazonMcf.translator.translate('Attribute'),
