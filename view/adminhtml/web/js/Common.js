define([
    'AmazonMcf/Plugin/Confirm',
    'AmazonMcf/Plugin/Alert',
    ...
    window.Common = Class.create({
        ...
        initCommonValidators: function () {
            var self = this;
            jQuery.validator.addMethod('AmazonMcf-required-when-visible', function (value, el) {
            ...
            }, AmazonMcf.translator.translate('This is a required field.'));

            jQuery.validator.addMethod('AmazonMcf-required-when-visible-and-enabled', function (value, el) {
            ...
            jQuery.validator.addMethod('AmazonMcf-validation-float', function (value, element) {
            ...
            }, AmazonMcf.translator.translate('Invalid input data. Decimal value required. Example 12.05'));

            jQuery.validator.addMethod('AmazonMcf-store-switcher-validation', function (value, element) {
                if (!element.visible()) {
                    return true;
                }
                ...
                return true;
            }, AmazonMcf.translator.translate('You should select Store View'));

            jQuery.validator.addMethod('AmazonMcf-validate-email', function (value, el) {
                this.error = Validation.get('validate-email').error;
                return Validation.get('validate-email').test(value, el);
            }, AmazonMcf.translator.translate('Email is not valid.'));
        },
        ...
        saveClick: function (url, skipValidation) {
            ...
            if (typeof url == 'undefined' || url == '') {
                url = AmazonMcf.url.get('formSubmit', {'back': base64_encode('list')});
            }
            this.submitForm(url);
        },
        ...
        saveAndEditClick: function (url, tabsId, skipValidation) {
            ...
            if (typeof url == 'undefined' || url == '') {
                ...
                url = AmazonMcf.url.get('formSubmit', {'back': base64_encode('edit' + tabsUrl)});
            }
            this.submitForm(url);
        },
        ...
        duplicateClick: function ($headId, chapter_when_duplicate_text) {
            ...
            AmazonMcf.url.add({'formSubmit': AmazonMcf.url.get('formSubmitNew')});
            ...
            $$('.AmazonMcf_duplicate_button').each(function (o) {
                o.hide();
            });
            $$('.AmazonMcf_delete_button').each(function (o) {
                o.hide();
            });
        ...
        deleteClick: function () {
            this.confirm({
                actions: {
                    confirm: function () {
                        setLocation(AmazonMcf.url.get('deleteAction'));
                    },
                    cancel: function () {
                        return false;
                    }
        ...
        setValidationCheckRepetitionValue: function (idInput, textError, model, dataField, idField, idValue, filterField, filterValue) {
            ...
            jQuery.validator.addMethod(
                    idInput, function (value) {
                        ...
                        new Ajax.Request(AmazonMcf.url.get('general/validationCheckRepetitionValue'), {
                            method: 'post',
                            asynchronous: false,
                            parameters: {
                                model: model,
